...
class Sudoku:
    ...
    def printSudoku(self):
        ...
        array.append(self.mat[0])
        array.append(self.mat[1])
        array.append(self.mat[2])
        array.append(self.mat[3])
        array.append(self.mat[4])
        array.append(self.mat[5])
        array.append(self.mat[6])
        array.append(self.mat[7])
        array.append(self.mat[8])

        return array


class Grid:
    generate_sudoku = Sudoku(9,40)
    generate_sudoku.fillValues()
    board = generate_sudoku.printSudoku()
...
def main():
    win = pygame.display.set_mode((590, 650))
